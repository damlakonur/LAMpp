...
class CafcaDataset(VideoDataset):
    def __init__(
        self,
    ...
    def load_camera_params(self):
        ...
        K = {k: torch.tensor(param["intrinsics"][k]) for k in self.camera_ids}
        ...
        for i, camera_id in enumerate(self.camera_ids):
            self.camera_params[camera_id] = {"intrinsic": K[camera_id], "extrinsic": extrinsic[i]}
